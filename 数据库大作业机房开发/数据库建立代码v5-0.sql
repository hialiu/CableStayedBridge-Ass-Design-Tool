...
CREATE TABLE bridgeModel(
	...
	modelSection	VARCHAR(20)
					CHECK(modelSection IN ('砼-边箱梁截面', '砼-带斜撑箱形截面','钢-边箱梁截面-1', '钢-边箱梁截面-2', '钢-分体式箱形截面', '钢-整体式箱形截面', '砼-肋板式截面', '实心板截面', '箱形截面')),
